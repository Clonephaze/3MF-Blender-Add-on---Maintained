  ...
  <build>
    <item objectid="100" />
        ...
        self.assertAlmostEqual(
            metallic, 0.95, places=2, msg=f"Metallic should be 0.95, got {metallic}"
        )

        # Check roughness value (should be 0.1)
        roughness = node.inputs["Roughness"].default_value
        self.assertAlmostEqual(
            roughness, 0.1, places=2, msg=f"Roughness should be 0.1, got {roughness}"
        )
...
<model xmlns="{NS_CORE}" xmlns:m="{NS_MATERIAL}" unit="millimeter">
  ...
  <build>
    <item objectid="100" />
        ...
        self.assertAlmostEqual(
            metal_node.inputs["Metallic"].default_value, 1.0, places=2
        )
        self.assertAlmostEqual(
            metal_node.inputs["Roughness"].default_value, 0.2, places=2
        )
        ...
        self.assertAlmostEqual(
            plastic_node.inputs["Metallic"].default_value, 0.0, places=2
        )
...
<model xmlns="{NS_CORE}" xmlns:m="{NS_MATERIAL}" unit="millimeter">
  ...
  <build>
    <item objectid="100" />
        ...
        self.assertAlmostEqual(ior, 1.5, places=2, msg=f"IOR should be 1.5, got {ior}")
        ...
        self.assertGreater(
            transmission, 0, "Transmission should be set for translucent material"
        )
...
<model xmlns="{NS_CORE}" xmlns:m="{NS_MATERIAL}" unit="millimeter">
  ...
  <build>
    <item objectid="100" />
        ...
        self.assertTrue(
            metallic_linked or roughness_linked,
...
<model xmlns="{NS_CORE}" xmlns:m="{NS_MATERIAL}" unit="millimeter">
  ...
  <build>
    <item objectid="100" />
        ...
        self.assertEqual(
            len(orig_colorgroups), len(exp_colorgroups), "Colorgroup count mismatch"
        )
        ...
        self.assertEqual(len(orig_colors), len(exp_colors), "Color count mismatch")
        ...
        self.assertEqual(
            sorted(orig_values), sorted(exp_values), "Color values not preserved"
        )
...
<model xmlns="{NS_CORE}" xmlns:m="{NS_MATERIAL}" unit="millimeter">
  ...
  <build>
    <item objectid="100" />
        ...
        input_path = self.create_test_3mf(
            model_xml, {"3D/Texture/diffuse.png": MINIMAL_PNG}
        )
        ...
        self.assertEqual(
            len(orig_textures), len(exp_textures), "Texture2d count mismatch"
        )
...
<model xmlns="{NS_CORE}" xmlns:m="{NS_MATERIAL}" unit="millimeter">
  ...
  <build>
    <item objectid="100" />
        ...
        input_path = self.create_test_3mf(
            model_xml, {"3D/Texture/test.png": MINIMAL_PNG}
        )
        ...
        self.assertEqual(
            len(orig_groups), len(exp_groups), "Texture2dgroup count mismatch"
        )
        ...
        self.assertEqual(len(orig_coords), len(exp_coords), "Tex2coord count mismatch")
...
<model xmlns="{NS_CORE}" xmlns:m="{NS_MATERIAL}" unit="millimeter">
  ...
  <build>
    <item objectid="100" />
        ...
        self.assertEqual(
            len(orig_comp), len(exp_comp), "Compositematerials count mismatch"
        )
        ...
        self.assertEqual(
            len(orig_composites), len(exp_composites), "Composite count mismatch"
        )
...
<model xmlns="{NS_CORE}" xmlns:m="{NS_MATERIAL}" unit="millimeter">
  ...
  <build>
    <item objectid="100" />
        ...
        scene = bpy.context.scene
        self.assertIn(
            "3mf_multiproperties", scene.keys(), "Multiproperties not stored in scene"
        )
        ...
        self.assertEqual(
            len(orig_multi), len(exp_multi), "Multiproperties count mismatch"
        )
        ...
        self.assertEqual(len(orig_multis), len(exp_multis), "Multi count mismatch")
...
<model xmlns="{NS_CORE}" xmlns:m="{NS_MATERIAL}" unit="millimeter">
  ...
  <build>
    <item objectid="100" />
        ...
        input_path = self.create_test_3mf(
            model_xml, {"3D/Texture/tex.png": MINIMAL_PNG}
        )
...
<model xmlns="{NS_CORE}" xmlns:m="{NS_MATERIAL}" unit="millimeter">
  ...
  <build>
    <item objectid="100" />
        ...
        input_path = self.create_test_3mf(
            model_xml, {"3D/Texture/star.png": MINIMAL_PNG}
        )
        self.assertTrue(self.import_3mf(input_path), "Import failed")
...
<model xmlns="{NS_CORE}" xmlns:m="{NS_MATERIAL}" unit="millimeter">
  ...
  <build>
    <item objectid="100" />
        ...
        self.assertEqual(
            len(orig_metals), len(exp_metals), "PB metallic count mismatch"
        )
...
<model xmlns="{NS_CORE}" xmlns:m="{NS_MATERIAL}" unit="millimeter">
  ...
  <build>
    <item objectid="100" />
        ...
        self.assertEqual(
            orig_attrs.get("basecolorfactor"), exp_attrs.get("basecolorfactor")
        )
        self.assertEqual(
            orig_attrs.get("metallicfactor"), exp_attrs.get("metallicfactor")
        )
        self.assertEqual(
            orig_attrs.get("roughnessfactor"), exp_attrs.get("roughnessfactor")
        )
...
<model xmlns="{NS_CORE}" xmlns:m="{NS_MATERIAL}" unit="millimeter">
  ...
  <build>
    <item objectid="100" />
        ...
        self.assertEqual(orig_attrs.get("name"), exp_attrs.get("name"))
        self.assertEqual(
            orig_attrs.get("diffusefactor"), exp_attrs.get("diffusefactor")
        )
        self.assertEqual(
            orig_attrs.get("specularfactor"), exp_attrs.get("specularfactor")
        )
        self.assertEqual(
            orig_attrs.get("glossinessfactor"), exp_attrs.get("glossinessfactor")
        )
